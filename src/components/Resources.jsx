    ...
    return (
        <div className="bg-white">
            ...
            <section className="bg-[#043873] text-white py-20 px-6 text-center">
                ...
                <button className="bg-[#4F9CF9] text-[#043873] px-8 py-4 rounded-lg font-bold text-lg hover:bg-[#3a85e0] transition-all flex items-center gap-2 mx-auto shadow-lg hover:shadow-xl translate-y-0 hover:-translate-y-1">
            ...
            <section className="py-20 px-6 max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    {/* Help Center */}
                    <div className="bg-gray-50 p-10 rounded-2xl hover:shadow-xl transition-all border border-gray-100 flex flex-col items-start">
                        <div className="bg-white p-4 rounded-full shadow-sm mb-6">
                            <LifeBuoy className="text-[#4F9CF9]" size={32} />
                        </div>
                        <h2 className="text-2xl font-bold text-[#043873] mb-4">Help Center</h2>
                        ...
                        <button className="text-[#4F9CF9] font-bold text-lg flex items-center gap-2 hover:gap-3 transition-all group">
                    ...
                    <div className="bg-gray-50 p-10 rounded-2xl hover:shadow-xl transition-all border border-gray-100 flex flex-col items-start">
                        <div className="bg-white p-4 rounded-full shadow-sm mb-6">
                            <BookOpen className="text-[#4F9CF9]" size={32} />
                        </div>
                        <h2 className="text-2xl font-bold text-[#043873] mb-4">Knowledge Base</h2>
                        <p className="text-gray-600 mb-8 leading-relaxed flex-grow">
                    ...
                    <div className="bg-gray-50 p-10 rounded-2xl hover:shadow-xl transition-all border border-gray-100 flex flex-col items-start">
                        <div className="bg-white p-4 rounded-full shadow-sm mb-6">
                            <FileText className="text-[#4F9CF9]" size={32} />
                        </div>
                        <h2 className="text-2xl font-bold text-[#043873] mb-4">Product Documentation</h2>
                        <p className="text-gray-600 mb-8 leading-relaxed flex-grow">
                    ...
                    <div className="bg-gray-50 p-10 rounded-2xl hover:shadow-xl transition-all border border-gray-100 flex flex-col items-start">
                        <div className="bg-white p-4 rounded-full shadow-sm mb-6">
                            <Headphones className="text-[#4F9CF9]" size={32} />
                        </div>
                        <h2 className="text-2xl font-bold text-[#043873] mb-4">Support & Assistance</h2>
                        <p className="text-gray-600 mb-8 leading-relaxed flex-grow">
                ...
                <div className="mt-20 bg-[#043873] rounded-2xl p-12 text-center relative overflow-hidden">
                    {/* Decorative element */}
                    ...
                    <div className="flex max-w-md mx-auto relative z-10">
                        <input
                            ...
                            className="w-full px-6 py-4 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#4F9CF9] text-gray-800"
                        />
                        <button className="bg-[#4F9CF9] text-[#043873] px-6 py-4 rounded-r-lg font-bold hover:bg-[#3a85e0] transition-colors">
                            Search
                        </button>
                    </div>
                </div>
