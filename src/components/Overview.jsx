            ...
            <section className="py-16 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100 max-w-4xl mx-auto">
                        <h2 className="text-2xl font-bold text-[#043873] mb-4">What Crivient Does</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-4 text-left">
                            <div className="flex items-center gap-3">
                                <CheckCircle className="text-[#4F9CF9] shrink-0" size={20} />
                                <span className="text-gray-700">Track leads and opportunities across the entire sales lifecycle</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <CheckCircle className="text-[#4F9CF9] shrink-0" size={20} />
                                <span className="text-gray-700">Manage customer interactions in real time</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <CheckCircle className="text-[#4F9CF9] shrink-0" size={20} />
                                <span className="text-gray-700">Automate follow-ups, tasks, and pipelines</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <CheckCircle className="text-[#4F9CF9] shrink-0" size={20} />
                                <span className="text-gray-700">Gain visibility into performance with powerful analytics</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Key Features */}
                <div className="mb-20">
                    <h2 className="text-3xl font-bold text-[#043873] mb-10 text-center">Key Features</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">

                        <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-shadow border border-gray-100">
                            <Users className="text-[#4F9CF9] mb-4" size={36} />
                            <h3 className="text-xl font-bold text-[#043873] mb-3">Unified Customer View</h3>
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-shadow border border-gray-100">
                            <TrendingUp className="text-[#4F9CF9] mb-4" size={36} />
                            <h3 className="text-xl font-bold text-[#043873] mb-3">Sales Pipeline Management</h3>
                            <p className="text-gray-600">
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-shadow border border-gray-100">
                            <Zap className="text-[#4F9CF9] mb-4" size={36} />
                            <h3 className="text-xl font-bold text-[#043873] mb-3">Automation & Workflows</h3>
                            <p className="text-gray-600">
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-shadow border border-gray-100">
                            <BarChart className="text-[#4F9CF9] mb-4" size={36} />
                            <h3 className="text-xl font-bold text-[#043873] mb-3">Analytics & Reporting</h3>
                            <p className="text-gray-600">
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-shadow border border-gray-100">
                            <MessageSquare className="text-[#4F9CF9] mb-4" size={36} />
                            <h3 className="text-xl font-bold text-[#043873] mb-3">Team Collaboration</h3>
                            <p className="text-gray-600">
                        ...
                        <div className="bg-gray-50 p-8 rounded-xl hover:shadow-lg transition-shadow border border-gray-100">
                            <ShieldCheck className="text-[#4F9CF9] mb-4" size={36} />
                            <h3 className="text-xl font-bold text-[#043873] mb-3">Secure & Scalable</h3>
                            <p className="text-gray-600">
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-20 items-stretch">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 h-full">
                        <h2 className="text-2xl font-bold text-[#043873] mb-6 flex items-center gap-3">
                            <Target className="text-[#4F9CF9]" /> Who Crivient Is For
                        </h2>
                        <p className="text-gray-600 mb-6">Crivient is ideal for:</p>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-[#4F9CF9] rounded-full mt-2"></div>
                                <span className="text-gray-700">Startups and SMBs looking to scale efficiently</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-[#4F9CF9] rounded-full mt-2"></div>
                                <span className="text-gray-700">Sales-driven organizations</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-[#4F9CF9] rounded-full mt-2"></div>
                                <span className="text-gray-700">Customer-focused teams that value data clarity</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 bg-[#4F9CF9] rounded-full mt-2"></div>
                                <span className="text-gray-700">Businesses that want a flexible, easy-to-adopt CRM</span>
                            </li>
                        </ul>
                    </div>

                    {/* Why Choose Crivient */}
                    <div className="bg-[#043873] text-white p-8 rounded-xl shadow-lg h-full">
                        <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
                            <Briefcase className="text-[#4F9CF9]" /> Why Choose Crivient?
                        </h2>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <CheckCircle className="text-[#4F9CF9] shrink-0" size={20} />
                ...
                <div className="text-center bg-gray-50 rounded-2xl p-12 border border-gray-200">
                    <Globe className="text-[#4F9CF9] mx-auto mb-6" size={48} />
                    <h2 className="text-3xl font-bold text-[#043873] mb-4">Grow With Confidence</h2>
